			...
			Subcategories: []*Subcategory{
				{
					...
					Packages: []*Package{
						...
						genericArchivePackage("actuate", "ardura", "FM/PM additive synth with macro-controlled performance layers, distributed as a Linux CLAP and VST3 archive."),
						genericArchivePackage("audible-planets", "gregrecco67", "Granular additive synth focused on evolving textures and atmospheric pads, distributed as a Linux LV2 bundle."),
						alienDebPackage("chow-kick", "Chowdhury DSP", "808-style drum synth with built-in sequencer, distributed as a Linux Debian package."),
						genericArchivePackage("fluida", "brummer10", "Additive FM synth focused on rich harmonic textures, distributed as a Linux LV2 bundle."),
						genericArchivePackage("geonkick-basic", "quamplex", "Percussive synth/sampler with built-in step sequencer, distributed as a Linux LV2 and VST3 archive."),
						genericArchivePackage("jc303", "midilab", "Roland TB-303-style acid bass synthesizer, distributed as a Linux CLAP, VST3, and LV2 archive."),
						genericArchivePackage("js80p", "attilammagyar", "Vector phase-distortion synth inspired by the Yamaha SY77/SY99 series, distributed as a Linux VST3 archive."),
						{
							ID:          "tal-noisemaker",
							Name:        "TAL-Noisemaker",
							Vendor:      "TAL Software",
						...
						genericArchivePackage("resonarium-instrument", "Gabriel Soule", "MPE-compatible physical modeling synth based on coupled string waveguide models, distributed as a Linux VST3 archive."),
						genericArchivePackage("six-sines", "baconpaul", "Six-operator audio-rate inter-modulation synth with PM/AM depth, distributed as a Linux CLAP and VST3 archive."),
						genericArchivePackage("terrain", "Aaron Anderson", "Wave-terrain synthesis instrument with per-sample trajectory and terrain calculation, distributed as a Linux CLAP and VST3 archive."),
					},
				},
				{
				...
				},
				{
					...
					Packages: []*Package{
						...
						genericArchivePackage("ami-sampler", "astriiddev", "Amiga-style tracker sampler with 8-bit/16-bit playback and vintage character, distributed as a Linux LV2 and VST3 archive. Requires `7z` or `bsdtar` to extract the upstream `.7z` archive."),
						genericArchivePackage("just-a-sample", "BOBONA", "Lightweight drum sample player with choke groups and humanize controls, distributed as a Linux VST3 archive."),
			...
			Subcategories: []*Subcategory{
				...
				},
				{
					...
					Packages: []*Package{
						...
						genericArchivePackage("qdelay", "tiagolr", "Multi-tap delay processor distributed as a Linux VST3 and LV2 archive."),
						genericArchivePackage("sirial", "tiagolr", "Serial-style delay with feedback and modulation, distributed as a Linux VST3 and LV2 archive."),
						genericArchivePackage("time-12", "tiagolr", "Multi-mode delay plugin distributed as a Linux VST3 and LV2 archive."),
						...
						genericArchivePackage("reevr", "tiagolr", "Convolution reverb focused on realistic spaces and impulse-response morphing, distributed as a Linux LV2 and VST3 archive."),
					},
				},
				{
					...
					Packages: []*Package{
						...
						genericArchivePackage("resonarium-effect", "Gabriel Soule", "Coupled-string waveguide physical modeling effect with MPE support, distributed as a Linux VST3 archive."),
						genericArchivePackage("solidutility", "SolidFuel", "Versatile VST3 channel utility for swapping/muting channels, mid-side encoding, phase invert, and DC offset removal, distributed as a Linux VST3 archive."),
					},
				},
			},
		},
